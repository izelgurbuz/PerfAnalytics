...
describe('AnalyticsChart Tests',()=>{
    ...
    it('if no data is given, chart class doesnt appear ', () => {
      const  {getByText, getByTestId, container} = render(<AppProvider><AnalyticsChart /></AppProvider>);
    ...
    it('if no data is given, -  appears ', () => {
      ...
      it('if data is given, chart class doesnt appear ', () => {
        const  {getByText, getByTestId, container} = render(<AppProvider><AnalyticsChart chartData={[['2821.400000035763','2021-07-25T13:17:35.555Z']]} /></AppProvider>);
        const content = container.querySelectorAll('.chart');
